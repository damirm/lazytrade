...
* [OptionBy](/invest/services/instruments/methods#optionby) — получить опцион по его идентификатору.
* [CurrencyBy](/invest/services/instruments/methods#currencyby) — получить валюту по ее идентификатору.
* [DfaBy](/invest/services/instruments/methods#dfaby) — получить смарт актив по его идентификатору.
...
<li><b>dlong_client</b> — лонг ставка риска начальной маржи, соответствующая вашему уровню риска.  </li>
<li><b>dshort_client</b> — шорт ставка риска начальной маржи , соответствующая вашему уровню риска.  </li>
</ul>
...
Смарт активы(цифровые активы) поддерживаются API с ограничениями. Доступный функционал:

* получить смарт активы можно методами [DfaBy](/invest/services/instruments/methods#dfaby) и [Dfas](/invest/services/instruments/methods#dfas);
* в [списке счетов](https://developer.tbank.ru/invest/services/accounts/users#getaccounts) возвращаются смарт счета;
* [портфель](https://developer.tbank.ru/invest/services/operations/methods#getportfolio) по смарт счетам;;
* [операции](https://developer.tbank.ru/invest/services/operations/methods#getoperationsbycursor) по смарт счетам;

Котировки, торговля, просмотр позиции по смарт активам через API не поддерживаются.